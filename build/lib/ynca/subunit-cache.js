...
function isAvailSnapshot(value) {
  ...
  return typeof candidate === "object" && candidate !== null && Array.isArray(candidate.subunits) && candidate.subunits.every((entry) => typeof entry === "string") && typeof candidate.model === "string" && typeof candidate.firmware === "string";
}
