...
export const CHANNEL_NAME_KEYS: Record<string, I18nKey> = {
  ...
  usb: "usb",
  napster: "napster",
  // Presets and their store came to Spotify and the media server with the RX-A850 list (2015),
  // so the two source folders exist again.
  server: "mediaServer",
  spotify: "spotify",
  pandora: "pandora",
  rhapsody: "rhapsody",
  sirius: "siriusSatelliteRadio",
  siriusInternetRadio: "siriusInternetRadio",
  siriusXm: "siriusxm",
  hdRadio: "hdRadio",
  airplay: "airplay",
  bluetooth: "bluetooth",
